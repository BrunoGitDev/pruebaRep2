...
public class Statistics {
     ...
     * The median is computed as the 50th percentile using Apache Commons Math's StatUtils utility class.
     *
     * @param arrayOfNumbers the array of double values for which the median is calculated
     * @return the median (50th percentile) of the given array
     * @throws IllegalArgumentException if the array is empty
     */
